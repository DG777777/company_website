  ...
  return (
        <nav className='fixed top-0 left-0 w-full bg-white text-black p-4 shadow-lg z-50'>
            <div className='container mx-auto flex justify-between items-center'>
                <h1 className='text-xl lg:text-2xl font-bold lg:ml-12 lg:mr-8'><a href='/'>ABC Company</a></h1>
                ...
                <select value={language} onChange={(e) => setLanguage(e.target.value)} className='hidden lg:block px-3 ml-3 border rounded-md bg-white hover:border-blue-500 transition duration-300'>
            ...
            <div className={`fixed top-0 right-0 h-full w-64 bg-white text-black transform transition-transform duration-300 ease-in-out z-70 ${isOpen ? "translate-x-0 " : "translate-x-full"} lg:hidden`}>
                 <div className='p-4'>
